...
<body>
   <div id="wrapper">
      ...
      <div id="content" class="insertBoardForm">
         <form th:action="insertBoardProc" method="post">
            <table>
            <colgroup>
               <col width="30%">
               <col width="70%">
               ...
               <tr>
                  ...
                  <input type="button" onclick="event.preventDefault(); location.href='/board/listBoard';" value="목록 으로" />
                  </td>
               </tr>
            </table>
         </form>
